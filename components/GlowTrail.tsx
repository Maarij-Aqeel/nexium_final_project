...
export default function GlowTrail({ children, className = "", rounded = "rounded-xl" }:GlowTrailProps) {
  return (
    <div
...
>
      ...
      <div className={`relative z-10 bg-background/80 ${rounded} w-full h-full flex items-center justify-center`}>
        {children}
      </div>
